...
from utils import plotepoch, plot_confusion_matrix
...
if __name__=="__main__":
    ...
    plotepoch(train_acc, 'Train_Accuracy')
    plotepoch(test_acc, 'Test_Accuracy')
    plotepoch(test_F1_score, 'Test_F1_score')

    cf_matrix = np.array([[371, 58],
                          [19, 176]])
